...
Checklist de Avaliação para a Sessão 1:

1. Construção de Rapport

[ ] O terapeuta se apresentou e explicou sua afiliação (ex: psicólogo do VA, profissional particular)? 

[ ] O terapeuta explicou o propósito do primeiro encontro? 

[ ] O terapeuta conduziu uma entrevista informal para obter informações-chave, perguntando sobre:

[ ] Vida do cliente (trabalho, estado civil, tempo livre, situação de moradia)? 

[ ] A percepção do cliente sobre a gravidade do problema com álcool?

[ ] As razões para procurar tratamento agora? 

[ ] Experiências com tratamentos anteriores? 

[ ] Tentativas anteriores de parar de beber por conta própria? 

[ ] As expectativas e ideias do cliente sobre como o tratamento deveria ser? 

[ ] Os objetivos do cliente com o tratamento? 

[ ] O nível de confiança do cliente no sucesso (manter a abstinência)? 

2. Conceitualização do Tratamento: O que é Alcoolismo? 

[ ] O terapeuta explicou o modelo de aprendizagem social do abuso de álcool (beber como um comportamento prejudicial aprendido)? 


[ ] O terapeuta explicou como o álcool é usado para alterar sentimentos (ex: como tranquilizante, para melhorar bons momentos)? 

[ ] O terapeuta mencionou o papel de gatilhos ambientais (ex: ver bebidas, estar com pessoas que bebem, estresse)? 

[ ] O terapeuta explicou o propósito do tratamento: "ajudá-lo a evitar ou lidar melhor com aquelas situações em que você tende a beber e a encontrar comportamentos que você pode fazer em vez de beber"? 

[ ] O terapeuta verificou a compreensão do cliente sobre o modelo apresentado? 

3. Avaliação de Situações de Alto Risco 

[ ] O terapeuta explicou o conceito de "situações de alto risco"? 

[ ] O terapeuta perguntou sobre gatilhos específicos, pedindo um exemplo concreto (ex: história de uma recaída)? 

[ ] O terapeuta investigou os pensamentos, sentimentos e as consequências (positivas e negativas) associadas ao episódio de consumo? 

[ ] O terapeuta introduziu e demonstrou o uso do "Self-Monitoring Record" (Registro de Automonitoramento) usando as respostas do cliente? 

4. Motivação 

[ ] O terapeuta expressou confiança na capacidade do cliente de ter sucesso no tratamento? 

[ ] O terapeuta ajudou o cliente a revisar as razões para parar de beber e elogiou o esforço do cliente em buscar tratamento? 

5. Contrato e Regras Básicas

[ ] O terapeuta enfatizou que o tratamento exige comprometimento e trabalho por parte do cliente? 

[ ] O terapeuta explicou as regras básicas sobre:

[ ] Frequência (participar de todas as sessões)? 

[ ] Pontualidade? 

[ ] Uso de álcool/drogas (objetivo de abstinência)? 

[ ] Conclusão das tarefas de casa? 

[ ] O terapeuta apresentou o "Contrato de Tratamento" para o cliente ler e assinar? 

6. Tarefa de Casa

[ ] O terapeuta designou o uso do "Self-Monitoring Record" para registrar episódios de fissura ou desejo por álcool durante a semana? 

[ ] O terapeuta marcou o próximo encontro?
...
Checklist de Avaliação para a Sessão 2:
1. Apresentação da Lógica (Rationale)

[ ] O terapeuta normalizou a fissura como uma experiência comum na recuperação, que não significa que algo está errado? 

[ ] O terapeuta explicou que as vontades são desencadeadas por gatilhos ambientais, emocionais e físicos? 

[ ] O terapeuta usou a metáfora da "onda" para descrever a natureza da fissura (aumenta, atinge um pico e depois diminui)? 

2. Ensino das Diretrizes de Habilidades (Skill Guidelines)

[ ] Habilidade 1: Reconhecer e Evitar Gatilhos

[ ] O terapeuta listou gatilhos comuns (ex: exposição ao álcool, ver outros bebendo, emoções específicas)? 

[ ] O terapeuta explicou que a maneira mais fácil de lidar com as fissuras é evitá-las (ex: remover o álcool de casa)? 

[ ] Habilidade 2: Estratégias de Enfrentamento

[ ] a. Atividade de Distração: O terapeuta sugeriu atividades como ler, hobbies, exercícios ou comer? 


[ ] b. Conversar sobre o Assunto: O terapeuta explicou o benefício de falar com amigos/familiares sobre a fissura? 

[ ] c. "Surfar na Vontade" (Urge Surfing):

    [ ] O terapeuta explicou a técnica usando a metáfora da onda ou da arte marcial (judo)? 


    [ ] O terapeuta descreveu os três passos essenciais da técnica: 1) Fazer um inventário corporal da fissura, 2) Focar em uma área e descrever as sensações, 3) Repetir o processo, notando as mudanças? 



[ ] d. Desafiar e Mudar Pensamentos:

    [ ] O terapeuta explicou a tendência de lembrar apenas dos efeitos positivos do álcool durante uma fissura? 

    [ ] O terapeuta sugeriu que o cliente se lembre das consequências negativas, possivelmente usando um cartão de lembrete? 


    [ ] O terapeuta explicou o conceito de "conversa interna" (self-talk) e como ela pode fortalecer ou enfraquecer as vontades? 

    [ ] O terapeuta ensinou os dois passos: 1) Identificar a conversa interna que piora a fissura e 2) Desafiá-la com afirmações construtivas? 


3. Exercícios em Sessão (In-Session Exercises)

[ ] O terapeuta trabalhou com o cliente para criar uma lista de seus gatilhos de fissura pessoais? 

[ ] O terapeuta ajudou o cliente a desenvolver um "plano para a fissura" personalizado, escolhendo 2 ou 3 das estratégias discutidas? 

[ ] O terapeuta praticou a técnica de "surfar na vontade" com o cliente durante a sessão? 

4. Tarefa de Casa e Folhas de Lembrete (Reminder Sheet and Practice Exercises)

[ ] O terapeuta forneceu a folha de lembrete "Coping with Cravings and Urges"?

[ ] O terapeuta atribuiu a tarefa de casa: preencher o "DAILY RECORD OF URGES TO DRINK" (Registro Diário de Vontades de Beber)? 

[ ] O terapeuta explicou como preencher o registro, incluindo a situação, a intensidade (1-100) e os comportamentos de enfrentamento utilizados? 
